...
apt-get update
apt install --assume-yes sudo wget curl xfce4 desktop-base xfce4-terminal bash zsh xvfb policykit-1 python3-psutil libcairo2  libgtk-3-0 libnspr4 libnss3 libpango-1.0-0 xbase-clients
...
apt-get -y install firefox=75.0+build3-0ubuntu1 zsh
